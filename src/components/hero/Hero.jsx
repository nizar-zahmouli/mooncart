  ...
  return (
    <>
      <section className="content flex justify-between lg:px-16 h-[50vh] lg:h-[90vh] relative z-20">
        <div className="left w-1/2 p-8 lg:py-64">
          <Title
            level={1}
      ...
      <div className="py-20 container flex flex-col lg:flex-row items-center gap-5">
        <div>
          <BannerCard
            ...
            desc="UP TO 60% OFF"
            cover="../../../public/images/hero/product1-1.png"
          />
        </div>
        <div className="flex justify-between flex-col gap-8">
          <BannerCard
            title="Wooden Water Bottles"
            desc="UP TO 60% OFF"
            cover="../../../public/images/hero/product2.png"
            className={true}
          />
          ...
          <BannerCard
            title="Wooden Water Bottles"
            desc="UP TO 60% OFF"
            cover="../../../public/images/hero/product3.png"
            className={true}
            classSecond={true}
          />
        </div>
